...
exports.updatePassword = exports.resetPassword = exports.restrictTo = exports.protect = exports.login = exports.signup = void 0;
...
exports.signup = catchAsync_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const newUser = yield userModel_1.create({
        name: req.body.name,
...
exports.login = catchAsync_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = yield userModel_1.findOne({ email }).select("+password");
...
exports.protect = catchAsync_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const decoded = yield util_1.promisify(jsonwebtoken_1.verify)(token, process.env.JWT_SECRET);
    const currentUser = yield userModel_1.findById(decoded.id);
    if (!currentUser) {
...
exports.resetPassword = catchAsync_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const hashedToken = crypto_1.createHash("sha256")
        .update(req.params.token)
        .digest("hex");
    const user = yield userModel_1.findOne({
...
exports.updatePassword = catchAsync_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield userModel_1.findById(req.user.id).select("+password");
